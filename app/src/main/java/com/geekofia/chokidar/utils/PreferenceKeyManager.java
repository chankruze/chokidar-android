...
public class PreferenceKeyManager {
    ...
    static {
        ...
        preferenceKeyItemHashMap.put(Constants.WRONG_PASSWORD_ALERT_SELFIE_SWITCH, new PreferenceKeyItem("wrong_password_alert_selfie_switch", "Wrong Password Alert Selfie Switch"));
    }
